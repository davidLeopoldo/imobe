    ...
    <Document>
      <Page size="A4" style={s.page}>
        ...
        <Text style={s.paragrafo}>
          LOCADOR: {contrato.proprietario_nome}, CPF nº {contrato.proprietario_cpf},
          residente e domiciliado em {contrato.proprietario_endereco}.
        </Text>
        <Text style={s.paragrafo}>
          LOCATÁRIO: {contrato.contraparte_nome}, CPF nº {contrato.contraparte_cpf},
        ...
        <Text style={s.secaoTitulo}>3. Do valor do aluguel e forma de pagamento</Text>
        <Text style={s.paragrafo}>
          O valor mensal do aluguel é de {formatCurrencyBRL(contrato.imovel_valor)}
        ...
        <Text style={s.paragrafo}>
          O prazo de locação é de {contrato.prazo_meses} meses, contados a partir de{" "}
          {formatDataBR(contrato.data_contrato)}. Reajuste, multas e juros não são
          calculados automaticamente pelo sistema e devem ser negociados diretamente
          entre as partes.
        </Text>
